...
$(w^*, b^*) \in \argmax_{w,b} \gamma[w, b](S)$ with $\gamma[w, b](S) := \min_{(x,y) \in S} \gamma[w, b](x, y)$
\end{subsubsectionbox}

\begin{subsubsectionbox}{Perceptron Learning}
if $f[w, b](x) \neq y$: update $w \leftarrow w + yx$, and $b \leftarrow b + y$

$w_0 \in \text{span}(x_1,\ldots,x_s) \Rightarrow w_t \in \text{span}(x_1,\ldots,x_s) (\forall t)$
\end{subsubsectionbox}
